...
public class LoRaBridgeDropDownReceiver extends DropDownReceiver implements
    ...
    public static final String SHOW_PLUGIN = "com.atakmap.android.LoRaBridge.SHOW_PLUGIN";
    ...
    /**************************** INHERITED METHODS *****************************/
    /**
     * Called when ATAK sends an intent to this receiver.
     * SHOW_PLUGIN triggers opening the main plugin dropdown UI.
     */
    @Override
